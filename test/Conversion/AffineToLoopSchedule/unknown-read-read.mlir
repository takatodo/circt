...
// CHECK-LABEL: func.func @unknown_read_read
// CHECK: loopschedule.pipeline
func.func @unknown_read_read(
    %arg0: memref<3xi32>, %arg1: memref<3xi32>, %condition: i1) {
  affine.for %i = 1 to 3 {
    ...
    affine.store %sum, %arg1[%i] : memref<3xi32>
  }
  return
}
