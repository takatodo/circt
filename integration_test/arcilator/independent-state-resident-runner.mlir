...
//
// RUN: mkdir -p %t.dir
// RUN: arcilator %s --state-file %t.dir/state.json -o %t.dir/shiftreg.ll
...
// RUN:
// RUN: int main() {
// RUN:   constexpr std::size_t caseCount = 32;
// RUN:   constexpr std::size_t steps = 5;
...
//
// CHECK: case_count=32 passed_count=32 failed_count=0 first_fail=none checksum=4208
