//===- AffineSlidingReuseSupport.h - Shared reuse analysis -----*- C++ -*-===//
//
...
#ifndef LIB_TRANSFORMS_AFFINESLIDINGREUSESUPPORT_H
#define LIB_TRANSFORMS_AFFINESLIDINGREUSESUPPORT_H
...
/// Return the first operation in the loop that may modify the source. Unknown
/// effects intentionally block transformations.
mlir::Operation *findModifyingOperation(mlir::affine::AffineForOp loop,
                                        mlir::Value source,
...
#endif // LIB_TRANSFORMS_AFFINESLIDINGREUSESUPPORT_H
